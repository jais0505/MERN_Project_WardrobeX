                            ...
                            {cartItems.map((item) => (
                                <div key={item._id} className={styles.cartItem}>
                                    ...
                                    <div className={styles.itemImage}>
                                        <img src={`http://127.0.0.1:5000/images/${item.productImage}`} alt={item.productName} />
                                        {!item.inStock && (
                                    ...
                                    <div className={styles.itemDetails}>
                                        <div className={styles.itemInfo}>
                                            ...
                                            <span className={styles.itemCategory}>{item.subcategoryId.name}</span>
                                            <div className={styles.itemSpecs}>
                                                <span><strong>Brand:</strong> {item.brandName}</span>
                                                <span><strong>Color:</strong> {item.colorName}</span>
                                                <span><strong>Size:</strong> {item.sizeName}</span>
                                            </div>
                                        </div>
