      ...
      {open && (
          <div ref={dropdownRef} className={styles.dropdown_menu}>
            <div className={styles.menu_options}>
              <NavLink to="/admin/profile" style={{ textDecoration: "none", color: "black", display: "flex", alignItems: "center" }}>
          ...
          <div className={styles.notification_list}>
            ...
            <div className={styles.message_container}>
              ...
              <div className={styles.message_content}>
                Congratulations! Your latest upload is now live and available
                for users to view.
              </div>
            </div>
          </div>
